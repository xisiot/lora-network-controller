...
class ProcessFlow {
  ...
  __getCmdHandlerFunc(devaddr, cid, payload, remains) {
    ...
    let cmdHandlerFuncs = {
      ...
      [constants.RXPARAMSETUP_CID]: fn.bind(_this, devaddr),
      [constants.RXTIMINGSETUP_CID]: fn.bind(_this, devaddr),
      [constants.NEWCHANNEL_CID]: fn.bind(_this, devaddr),
      [constants.DUTYCYCLE_CID]: fn.bind(_this, devaddr),
